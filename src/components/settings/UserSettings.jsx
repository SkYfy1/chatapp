...
const UserSettings = ({ close }) => {
    ...
    const returnImage = async (e) => {
        e.stopPropagation();
        await userService.returnUserImage(avatars[showImg], userInfo.avatar, userInfo.id)
        console.log('meow')
    }
            ...
            <div className='main'>
                ...
                <div className='settings-list'>
                    <div className='settings-list-item'>
                        ...
                        <div>
                            ...
                            {userInfo.phoneNumber && <span>{language.settings.information[lang][0]}</span>}
                        </div>
                    </div>
                    <div className='settings-list-item'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                        ...
                        <div>
                            ...
                            <span>{language.settings.information[lang][1]}</span>
                        </div>
                    </div>
                    <div className='settings-list-item'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                        ...
                        <div>
                            ...
                            <span>{language.settings.information[lang][2]}</span>
                        </div>
                    </div>
                </div>
                <div className='settings-list2'>
                    <div>
                        ...
                        <p>{language.settings.settingsList[lang][0]}</p>
                    </div>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                        ...
                        <p>{language.settings.settingsList[lang][1]}</p>
                    </div>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M14.857 17.082a23.848 23.848 0 0 0 5.454-1.31A8.967 8.967 0 0 1 18 9.75V9A6 6 0 0 0 6 9v.75a8.967 8.967 0 0 1-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 0 1-5.714 0m5.714 0a3 3 0 1 1-5.714 0" />
                        </svg>
                        <p>{language.settings.settingsList[lang][2]}</p>
                    </div>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M9 3.75H6.912a2.25 2.25 0 0 0-2.15 1.588L2.35 13.177a2.25 2.25 0 0 0-.1.661V18a2.25 2.25 0 0 0 2.25 2.25h15A2.25 2.25 0 0 0 21.75 18v-4.162c0-.224-.034-.447-.1-.661L19.24 5.338a2.25 2.25 0 0 0-2.15-1.588H15M2.25 13.5h3.86a2.25 2.25 0 0 1 2.012 1.244l.256.512a2.25 2.25 0 0 0 2.013 1.244h3.218a2.25 2.25 0 0 0 2.013-1.244l.256-.512a2.25 2.25 0 0 1 2.013-1.244h3.859M12 3v8.25m0 0-3-3m3 3 3-3" />
                        </svg>
                        <p>{language.settings.settingsList[lang][3]}</p>
                    </div>
                    <div className='language'>
                        <svg onClick={(e) => setShowPop(prev => !prev)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                            <path strokeLinecap="round" strokeLinejoin="round" d="m10.5 21 5.25-11.25L21 21m-9-3h7.5M3 5.621a48.474 48.474 0 0 1 6-.371m0 0c1.12 0 2.233.038 3.334.114M9 5.25V3m3.334 2.364C11.176 10.658 7.69 15.08 3 17.502m9.334-12.138c.896.061 1.785.147 2.666.257m-4.589 8.495a18.023 18.023 0 0 1-3.827-5.802" />
                        </svg>
                        <p onClick={(e) => setShowPop(prev => !prev)}>{language.settings.settingsList[lang][4]}</p>
                        {showPop && <PopUp changeStatePop={(data) => setShowPop(data)} changeLanguage={(data) => setLanguage(data)}/>}
                    </div>
                </div>
            </div>
